                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-laptop"></i>类别指定</li>
                        </ol>
                    </div>
                </div>
                ...
                <section class="panel">
                    <header class="panel-heading tab-bg-primary ">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#home">类别指定</a>
                            </li>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            ...
                            <form id="scform" method="post" action="/save">
                                <div class="form-group scButs">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-primary addButs" type="submit">保存</button>
                                ...
                                <div class="scForms">
                                    <div class="eXtremeTable" >
                                        <table id="ec_table" class="tableRegion" width="98%" >
                                            <!--隐藏域用来传递数据  -->
                                            <input type="hidden" id="spotsId" name="spotsId" value="${spotsId}"/>
...
<script type="text/javascript">
    ...
    /*var zNodes =*/
    var zNodes =[{id:"1",name:"mmm",checked:"true"},{id:"2",pid:"1",name:"ddd",checked:"true"}];
    ...
    function submitCheckedNodes(treeNode) {
        ...
        $('#categoryIds').val(str);		//将拼接完成的字符串放入隐藏域，这样就可以通过post提交
    }
