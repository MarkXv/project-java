...
<body>
    ...
    <div class="header" id="home">
        ...
        <div class="header-banner">
            <!-- Top Navigation -->
            <section class="bgi banner5"><h2 id="spotsName"><%-- ${spots.spotsName} --%></h2> </section>
            <!--gallery-->
        ...
        <div class="advantages">
            <div class="container">
                        ...
                        <div class="ad-mian">
                            ...
                            <div class="ad-right">
                                ...
                                <div id="ticketInfo" class="collapse">
                                    <p id="ticketPrice">${spots.ticketPrice}</p>
                                </div>
                                <button type="button" class="btn btn-primary" data-toggle="collapse"
                        ...
                        <div class="ad-mian">
                            ...
                            <div class="ad-right">
                                ...
                                <div id="timeInfo" class="collapse in">
                                    <p id="openTime">${spots.openTime}</p>
                                </div>
                                <button type="button" class="btn btn-primary" data-toggle="collapse"
                ...
                <div class="col-md-6 advantages-left heading">
                    ...
                    <div class="advn-two">
                        <ul>
                            <li class="simpleDetail"><span id="tel">${spots.telephone}</span></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-6 advantages-left heading">
                    ...
                    <div class="advn-two">
                        <ul>
                            <li><a href="${spots.addr}" id="website">${spots.addr}</a></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-6 advantages-left heading">
                    ...
                    <div class="advn-two">
                        <ul>
                            <li class="simpleDetail"><span id="advice">故宫游客非常多，至少需要半天时间参观，若时间充裕，建议1天为佳。</span></li>
                        </ul>
                    </div>
...
<!--请求景点详情 -->
    <script  type="text/javascript" src="http://manage.wn.com/spots/query?callback=details&spotsId=${spots.spotsId}"/>