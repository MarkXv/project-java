        ...
        $.validator.setDefaults({
            submitHandler: function () {
               ...
               /*  var username = document.getElementById("username");
                ...
                jsonp.src="http://sso.wn.com/login?callback='login'&username='"+username+"''&password='"+password+"'";
                docum ent.getElementsByTagName("head")[0].appendChild(jsonp); */
            }
        });
        $().ready(function () {
...
<div class="container">
    ...
    <form class="login-form" action="/user/login" id="commentForm" >
        <div class="login-wrap">
            <p class="login-img"><i class="icon_lock_alt"></i></p>
            <div class="input-group">
                <span class="input-group-addon"><i class="icon_profile"></i></span>
                <input id="username" type="text" class="form-control" placeholder="Username" name="username" value="${cookie.autologin.value}" autofocus required>
            </div>
            <div class="input-group">
            ...
            <h5 id="errInfo" class="" style="color:red">
