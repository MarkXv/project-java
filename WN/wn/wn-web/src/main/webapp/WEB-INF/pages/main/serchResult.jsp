...
<head>
    ...
    <%--搜索js--%>
     	<!-- 初始化后立刻执行首页的搜索请求  待开发 -->
    <%-- <script type="text/javascript" src="http://search.wn.com/spots/search?callback='searchSpots'&arg='${serchArg}'"/> --%>
    <script>
        function serch() {
...
<div class="header" id="home">
    ...
    <div class="header-banner">
        <!-- Top Navigation -->
        <section class="bgi banner5"><h2>搜&nbsp;索&nbsp;结&nbsp;果</h2> </section>
        <!--gallery-->
                        ...
                        <div id="conditions">
                            ...
                            <div id="serchBut">
                                <div class="input-group" style="width: 75%">
                                    <input id="serch" type="text" class="form-control input-lg" placeholder="例如：故 宫"><span  class="input-group-addon btn btn-primary" ><a
                                        href="javascript:;" onclick="serch()">搜索</a></span>
                                </div>
                            </div>
                            <ul style="text-align: left; width:80%;margin-left: 0px;padding-left: 0px">
                                <li style="display: inline-block; width:150px">匹配到:</li>
                                <c:if test="${ !empty condition.spotsName}"><li style="display: inline-block;width:100px;">名称：${condition.spotsName}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.ticketPrice}"><li style="display: inline-block;width:100px;">票价：${condition.ticketPrice}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.category.categoryName}"><li style="display: inline-block;width:100px;">分类：${condition.category.categoryName}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.openTime}"><li style="display: inline-block;width:100px;">开放时间：${condition.openTime}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.remark}"><li style="display: inline-block;width:100px;">简介：${condition.remark}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.telephone}"><li style="display: inline-block;width:100px;">电话：${condition.telephone}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.longitude}"><li style="display: inline-block;width:100px;">经度：${condition.longitude}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.latitude}"><li style="display: inline-block;width:100px;">纬度：${condition.latitude}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.traffic}"><li style="display: inline-block;width:100px;">交通：${condition.traffic}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.station}"><li style="display: inline-block;width:100px;">地址：${condition.station}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.orderNo}"><li style="display: inline-block;width:100px;">排序号：${condition.orderNo}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.addr}"><li style="display: inline-block;width:100px;">网址：${condition.addr}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.state}"><li style="display: inline-block;width:100px;">状态：${condition.state}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.pictureList}"><li style="display: inline-block;width:100px;">图片列表：${condition.pictureList}&nbsp;&nbsp;&nbsp;</li></c:if>
                                <c:if test="${ !empty condition.flow}"><li style="display: inline-block;width:100px;">浏览量：${condition.flow}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li></c:if>
                                <li style="display: inline-block;width:100px;">共：${counts}条</li>
                                <%--<li>&nbsp;</li>--%>
                                <%--<li>&nbsp;</li>--%>
                                <%--<li>&nbsp;</li>--%>
                                <%--<li>&nbsp;</li>--%>
                            ...
                            <c:if test="${counts==0}"><h4 style="color: red;">很抱歉，没能满足你，找到0条记录</h4></c:if>
