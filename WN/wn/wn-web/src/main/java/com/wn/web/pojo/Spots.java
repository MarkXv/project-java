...
public class Spots extends BaseEntity {
	...
	public Spots(String spotsId, String spotsName, String ticketPrice, String remark, String telephone,
			String longitude, String latitude, String traffic, String station, Integer orderNo, String openTime,
			String addr, Integer state, List<Picture> pictureList, Category category, Flow flow) {
		this.spotsId = spotsId;
		this.spotsName = spotsName;
		this.ticketPrice = ticketPrice;
		this.remark = remark;
	...
	public String toString() {
		return "Spots{" + "spotsId='" + spotsId + '\'' + ", spotsName='" + spotsName + '\'' + ", ticketPrice='"
				+ ticketPrice + '\'' + ", remark='" + remark + '\'' + ", telephone='" + telephone + '\''
				+ ", longitude='" + longitude + '\'' + ", latitude='" + latitude + '\'' + ", traffic='" + traffic + '\''
				+ ", station='" + station + '\'' + ", orderNo=" + orderNo + ", openTime='" + openTime + '\''
				+ ", addr='" + addr + '\'' + ", state=" + state + ", pictureList=" + pictureList + ", category="
				+ category + ", flow=" + flow + '}';
	}
