                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="fa fa-laptop"></i><a href="">用户管理</a></li>
                            <li><i class="fa fa-laptop"></i>角色指定</li>
                        </ol>
                    </div>
                </div>
                ...
                <section class="panel">
                    <header class="panel-heading tab-bg-primary ">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a data-toggle="tab" href="#home">角色指定</a>
                            </li>
                            ...
                            <form method="post" action="">
                                ...
                                <div class="form-group scButs">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button class="btn btn-primary addButs" type="submit" onclick="submitCheckedNodes();formsubmit('/backend/sysadmin/user/saveUserRole',1)">保存</button>
...
<!-- zTree树的js文件-->
<script type="text/javascript" src="/staticfiles/backend/js/jquery-1.4.4.min.js"></script>
