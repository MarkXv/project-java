                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><i class="icon_genius"><a href="/">角色管理</a></i></li>
                                                ...
                                                <div class="form">
                                                    <form class="form-validate form-horizontal" id="feedback_form" method="post" action="">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <input class="form-control" id="cname" name="roleId" value="${role.roleId}" maxlength="20" type="text" required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <input class="form-control " id="tel" type="tel" name="name" value="${role.name}" maxlength="20" required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <input class="form-control" id="addr" name="cardNo" value="role.cardNo" minlength="5" type="text" required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <textarea class="form-control" id="remark" name="remark"  type="text" required >${role.remark}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-offset-2 col-lg-10">
                                                                <button class="btn btn-primary addButs" type="submit" onclick="formsubmit('/backend/sysadmin/role/roleupdate',2)">保存</button>
