                                            ...
                                            <div class="form">
                                                <form class="form-validate form-horizontal" id="feedback_form" method="post" action="">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="moduleId" name="moduleId" value="${module.moduleId}" maxlength="20" type="text" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class="form-control " id="name" value="${module.name}" type="tel" name="tel" maxlength="20" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" id="remark" name="remark" type="text" required >${module.remark}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" id="ctype" name="ctype" type="text" required >${module.ctype}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="remark" class="control-label col-lg-2">排序号： <span class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" id="remark" name="remark" type="text" required >${module.orderNo}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-offset-2 col-lg-10">
                                                            <button class="btn btn-primary addButs" type="submit" onclick="formsubmit('/backend/sysadmin/module/updatemodule',3)">修改</button>
