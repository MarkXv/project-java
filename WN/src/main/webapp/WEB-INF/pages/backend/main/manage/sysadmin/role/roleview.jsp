                                        ...
                                        <div class="col-sm-6">
                                            <section class="panel">
                                                ...
                                                <table class="tableView">
                                                    ...
                                                    <tr  class="singleRow">
                                                        <td></td><td></td><td>角色ID：</td><td>${role.roleId}</td><td></td> <td></td><td>等级：</td><td>${role.name}</td><td></td><td></td>
                                                    </tr>

                                                    <tr  class="dubleRow">
                                                        <td></td><td></td><td>排序号：</td> <td>${role.orderNo}</td><td></td><td></td><td>说明：</td> <td>${role.remark}</td><td></td><td></td>
                                                    </tr>
