                                            ...
                                            <div class="form">
                                                <form class="form-validate form-horizontal" id="feedback_form" method="post" action="">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="cname" name="categoryName"  maxlength="20" type="text"  required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-offset-2 col-lg-10">
                                                            <button class="btn btn-primary addButs" type="submit" onclick="formsubmit('/backend/category/save',2)">新增</button>
