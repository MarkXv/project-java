                                                ...
                                                <form class="form-validate form-horizontal" id="feedback_form"
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="orderNo" class="control-label col-lg-2">网址： <span
                                                                class="required"></span></label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="website" name="addr" type="url"
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="station1" class="control-label col-lg-2">经度： <span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="station1" name="longitude"
                                                                   type="text" required/>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="station2" class="control-label col-lg-2">纬度： <span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control" id="station2" name="latitude"
                                                                   type="text" required/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="website" class="control-label col-lg-2">排序号：<span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control " id="orderNo" type="number"
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="website" class="control-label col-lg-2">图片：<span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <input class="form-control " id="imgurl" type="url"
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" id="remark" name="remark"
                                                                      minlength="5" type="text" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="trans" class="control-label col-lg-2">地点：<span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control " id="station" name="station"
                                                                      required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="trans" class="control-label col-lg-2">交通：<span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control " id="traffic" name="traffic"
                                                                      required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="opentime" class="control-label col-lg-2">开放时间： <span
                                                                class="required">*</span></label>
                                                        <div class="col-lg-10">
                                                            <textarea class="form-control" id="opentime" name="opentime"
                                                                      maxlength="500" type="text" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-offset-2 col-lg-10">
                                                            <button class="btn btn-primary addButs" type="button" onclick="formsubmit('/backend/spots/save',1)">创建
                                                            </button>
