...
//                    $.get('http://localhost:8090/talk/get',UUID,function (result) {   错    !!!!!!!!!!
                $.get('http://localhost:8090/talk/get',"UUID="+cUUID,function (result) {
...
//                    }
        ...
        function sendTalk() {
            ...
            $.get('http://localhost:8090/talk/add',msg,function (result) {
//                alert("huouqu"+result);
            });
                        ...
                        <div id="topDiscuss_Div">
                            ...
                            <div style="display: block;width: 100%;height:130px ;overflow: hidden;">
                                <ul id="talks">
                                    ...
                                    格式：
                                    留言13个汉字+3个点 -->
                                    <li><span class="demo2">我：你好哈哈哈哈哈哈哈哈哈</span></li>
