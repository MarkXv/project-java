                ...
                <div class="gallery-grids" style="margin-left: 10%">
                    <section>
                        ...
                        <div id="conditions">
                            ...
                            <ul class="conditionsUL">
                                <li>匹配到:</li>
                                <c:if test="${ !empty condition.spotsName}">名称：${condition.spotsName}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.ticketPrice}">票价：${condition.ticketPrice}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.category.categoryName}">分类：${condition.category.categoryName}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.openTime}">开放时间：${condition.openTime}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.remark}">简介：${condition.remark}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.telephone}">电话：${condition.telephone}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.longitude}">经度：${condition.longitude}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.latitude}">纬度：${condition.latitude}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.traffic}">交通：${condition.traffic}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.station}">地址：${condition.station}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.orderNo}">排序号：${condition.orderNo}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.addr}">网址：${condition.addr}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.state}">状态：${condition.state}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.pictureList}">图片列表：${condition.pictureList}</c:if>&nbsp;&nbsp;&nbsp;
                                <c:if test="${ !empty condition.flow}">浏览量：${condition.flow}</c:if>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                共：${counts}条
                                <%--<li>&nbsp;</li>--%>
                                <%--<li>&nbsp;</li>--%>
                                <%--<li>&nbsp;</li>--%>
