...
import cn.powerun.springBoot.shiro.UserRealm;
...
class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager){
        ...
        shiroFilterFactoryBean.setSuccessUrl("/index");//设置登录成功的界面
        shiroFilterFactoryBean.setUnauthorizedUrl("/403");//设置未对其授权的界面
